...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Engineer/Engineerport.css') }}">
    ...
    <body>
        <div class="container">
            <table id="equipmentTable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                <h1>รายการแจ้งซ่อมสำหรับช่าง</h1>
                <thead class="colum">
                    <tr>
                        <th></th>
                ...
                <tbody>
                    @foreach ($reports as $report)
                        @if (in_array($report->status, ['กำลังดำเนินการ']))
                            <tr>
                                <td></td>
                                ...
                                <td>
                                    <button onclick="loadPage('{{ route('Engineer.edit', $report->report_id) }}')"
