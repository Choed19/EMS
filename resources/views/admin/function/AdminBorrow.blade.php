...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/Adminborrow.css') }}">
        ...
        <link href="https://fonts.googleapis.com/css2?family=Prompt:wght@100;200;300;400;500;600;700&display=swap"
            ...
            <link rel="preconnect" href="https://fonts.googleapis.com">
            <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <title>AdminBorrowingList</title>
        ...
        <table id="equipmentTable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
            ...
            <tbody>
                @foreach ($borrowings as $borrowing)
                    @if (in_array($borrowing->status, ['รอ']))
                        <tr>
                            <td></td>
                            ...
                            <td>
                                <button onclick="loadPage('{{ route('borrowings.edit', $borrowing->borrow_id) }}')" class="btn">Check</button>
                            </td>
                        </tr>
                    @endif
                @endforeach
