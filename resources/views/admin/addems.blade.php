...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/admin/addems.css')}}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('equipment.store') }}" method="post">
                        ...
                        <label for="create_by">ผู้สร้าง</label>
                        <input type="text" name="create_by" id="create_by" required>

                        <label for="update_by">ผู้แก้ไข</label>
                        <input type="text" name="update_by" id="update_by" required>
